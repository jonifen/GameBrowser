...
{
    public class WhenGetInfoIsSuccessful
    {
        ...
        public async Task SetUp()
        {
            ...
            _protocolClient.Setup(c => c.GetInfo(_ipAddress, _port)).ReturnsAsync(_expectedResponse);

            _gameClient = new Quake3GameClient(_protocolClient.Object);
            _response = await _gameClient.GetInfo(_ipAddress, _port);
        }
