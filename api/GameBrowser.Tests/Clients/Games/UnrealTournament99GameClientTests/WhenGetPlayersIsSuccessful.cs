...
{
    public class WhenGetPlayersIsSuccessful
    {
        ...
        public async Task SetUp()
        {
            ...
            _protocolClient.Setup(c => c.GetPlayers(_ipAddress, _port)).ReturnsAsync(_expectedResponse);

            _gameClient = new UnrealTournament99GameClient(_protocolClient.Object);
            _response = await _gameClient.GetPlayers(_ipAddress, _port);
        }
