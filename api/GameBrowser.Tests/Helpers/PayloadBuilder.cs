...
namespace GameBrowser.Tests.Helpers
{
    public static class PayloadBuilder
    {
        ...
        public static ServerResponse BuildValidServerResponse()
        {
        ...
        public static ServerStatusDetails BuildMappedResponse()
        {
        ...
        public static ServerStatusDetails BuildInvalidMappedResponse()
        {
            return new ServerStatusDetails
            {
                Name = "Unknown"
        ...
        public static ServerResponse BuildInvalidServerResponse()
        {
            return new ServerResponse
            {
                Error = "no bueno",
